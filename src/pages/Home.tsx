...
import { Trophy, Play, Star, BookOpen, FastForward } from 'lucide-react';

export default function Home() {
  const navigate = useNavigate();
  const { initGame, normalCleared, hardCleared, eliteCleared, fragments, points, cards, isGameOver, isWin } = useGameStore();
