...
<div id="nav-right">
    ...
    <!-- 随机前往一个开往项目网站 -->
    <div class="nav-button only-home" id="travellings_button" title="随机前往一个开往项目网站" <?php /* if() */ ?>>
    ...
    <div class="nav-button" id="randomPost_button" <?php /* if() */ ?>>
    ...
    <!-- 切换模式 -->
    <div class="nav-button" id="darkmode_button" <?php /* if() */ ?>>
    ...
    <!-- 搜索使用搜索插件 -->
    <div class="nav-button" id="search-button" <?php /* if() */ ?>>
    ...
    <div <?php /* if() */ ?> class="console-button" tabindex="-1">
    ...
    <div <?php /* if() */ ?> class="nav-button" id="nav-console">
