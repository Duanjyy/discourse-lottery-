<th:block th:fragment="comment(group, kind, name, allowComment)" <?php /* if(${allowComment && theme.config.comments.commentsEnable}) */ ?>>
    ...
    <div id="post-comment">
        <div class="comment-head">
            ...
            <div  class="comment-randomInfo">
                <a <?php /* if(${theme.config.comments.visitorMail.visitorMailEnable}) */ ?>
        ...
        <div <?php /* if(${#strings.equals(theme.config.comments.use, 'Artalk') && not #strings.isEmpty(theme.config.comments.artalks.server)}) */ ?>
             id="artalk-wrap"></div>
        ...
        <halo:comment <?php /* if(${pluginFinder.available('PluginCommentWidget') && #strings.equals(theme.config.comments.use, 'commentWidget')}) */ ?>
